...
seednumber = 1
outheader = paste0(out.dir,"simpheno-all-",seednumber)

## run from scratch if this changes
from_scratch = TRUE
...
## calculate h2left using ch11 to ch22 
if(from_scratch)
{gctafile = paste0(bin.dir,"gcta64")
...
comm = paste0(gctafile, " --reml ", " --grm ", outheader, " --pheno ", phenofile ,"  --grm-cutoff 0.025 ", " --out ", outheader, "-gcta-all")
print(comm)
system(comm)

comm = paste0(gctafile, " --reml ", " --grm ", outheader, "-left --pheno ", phenofile , " --grm-cutoff 0.025 "," --out ", outheader, "-gcta-left")
print(comm)
system(comm)

comm = paste0(gctafile, " --reml ", " --grm ", outheader, "-right --pheno ", phenofile , " --grm-cutoff 0.025 "," --out ", outheader, "-gcta-right")
print(comm)
system(comm)
