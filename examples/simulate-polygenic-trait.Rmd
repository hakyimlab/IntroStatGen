...
comm = paste0(gctafile, " --reml ", " --grm ", outheader, " --pheno ", phenofile , " --out ", outheader, "-gcta-all")
print(comm)
system(comm)

comm = paste0(gctafile, " --reml ", " --grm ", outheader, "-left --pheno ", phenofile , " --out ", outheader, "-gcta-left")
print(comm)
system(comm)

comm = paste0(gctafile, " --reml ", " --grm ", outheader, "-right --pheno ", phenofile , " --out ", outheader, "-gcta-right")
print(comm)
system(comm)
...
## generate PCs with gcta (we have plink pcs but need to get rid of header and I only want 5 pcs)
