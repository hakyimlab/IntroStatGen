...
gist.dir = "/home/haky/IntroStatGen/IntroStatGen/examples/"
```
...
comm = paste0(bin.dir,"plink --bfile ", data.dir,"hapmap-common --score ", weightfile, " header sum --out ", out.dir,"polyscore-seed",seednumber)
print(comm)
system( comm )
...
nsamp = nrow(PSdata)
set.seed(seednumber + 2); epsilon = rnorm(nsamp,mean=0,sd=sqrt(0.2)) ## use seednumber + 1 
