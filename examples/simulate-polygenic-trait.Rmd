...
Calculate GRM. This takes long time, and you may need 4GB+ of memory. 
...
if(from_scratch)
{
comm = paste0(gctaname, " --bfile ", bedheader," --make-grm-bin --out ", outheader)
print(comm)
system(comm)
}
